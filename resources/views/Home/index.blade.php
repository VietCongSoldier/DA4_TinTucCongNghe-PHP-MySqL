        ...
        <section class="section first-section" ng-app='myapp' ng-controller = 'mycontroller'>
            <div class="container-fluid">
                <div class="masonry-blog clearfix">
                        ...
                        <div class="masonry-box post-media">
                             ...
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="/home/@{{new.id_loai_tin}}" title="">@{{new.id_loai_tin}}</a></span>
                                        <h4><a href="/home/chitietnews?id=@{{new.id}}" title="">@{{new.title}}</a></h4>
                                        <small><a href="/home/chitietnews?id=@{{new.id}}" title="">24 July, 2021</a></small>
                    ...
                    <div class="second-slot" ng-repeat = "new in news |filter:'Smartphone' | limitTo : 4">
                        <div class="masonry-box post-media">
                             <img src="\resources\img\Tintuc@{{new.image}}" alt="" class="img-fluid">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="/home/@{{new.id_loai_tin}}" title="">@{{new.id_loai_tin}}</a></span>
                                        <h4><a href="/home/chitietnews?id=@{{new.id}}" title="">@{{new.title}}</a></h4>
                                        <small><a href="/home/chitietnews?id=@{{new.id}}" title="">03 July, 2021</a></small>
                                        <small><a href="/home/author" title="">by Viet</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end shadow-desc -->
                             </div><!-- end shadow -->
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">                      
                        <div class="page-wrapper">
                            ...
                            <hr class="invis">
                                <h4 class="pull-left">Tin Tức Mới Nhất <a href="/home/"><i class="fa fa-rss"></i></a></h4>
                            </div><!-- end blog-top -->
