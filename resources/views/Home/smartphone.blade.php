                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">                      
                        <div class="page-wrapper">
                            ...
                            <hr class="invis">
                                <h4 class="pull-left">Tin Tức Smartphone Mới Nhất <a href="/home/"><i class="fa fa-rss"></i></a></h4>
                            </div><!-- end blog-top -->
                            <div class="blog-list clearfix">
                                <div class="blog-box row" dir-paginate = "new in news|filter:q|filter:'Smartphone'|itemsPerPage: pageSize" current-page="currentPage">
                                    <div class="col-md-4">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <div class="sidebar" ng-app='myapp' ng-controller = 'mycontroller'>
                            <div class="widget">
                                <h2 class="widget-title">Computer News</h2>
                                <div class="trend-videos">
                                    <div class="blog-box" ng-repeat = "new in news|filter:'Computer'|limitTo:6">
                                        <div class="post-media" >
                                            <a href="/home/chitietnews?id=@{{new.id}}" title="">
                                                <img src="\resources\img\Tintuc@{{new.image}}" alt="" class="img-fluid">
