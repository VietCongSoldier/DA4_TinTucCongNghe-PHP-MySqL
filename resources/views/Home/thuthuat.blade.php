                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">                      
                        <div class="page-wrapper">
                            ...
                            <div class="blog-list clearfix">
                                <div class="blog-box row" dir-paginate = "new in news|filter:q|filter:'Thủ Thuật'|itemsPerPage: pageSize" current-page="currentPage">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="/home/chitietnews?id=@{{new.id_new}}" title="">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="/home/chitietnews?id=@{{new.id_new}}" title="">@{{new.title}}</a></h4>
                                        <p>@{{new.content}}.</p>
                                        <small class="firstsmall"><a class="bg-orange" href="/home/@{{new.id_loai_tin}}" title="">@{{new.id_loai_tin}}</a></small>
                                        <small><a href="/home/chitietnews?id=@{{new.id_new}}" title="">21 July, 2022</a></small>
                                        <small><a href="/home/author" title="">by Việt</a></small>
                                        <small><a href="/home/chitietnews?id=@{{new.id_new}}" title=""><i class="fa fa-eye"></i> @{{new.numread}}</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end blog-box -->
