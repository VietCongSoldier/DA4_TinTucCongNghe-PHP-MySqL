    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <tr dir-paginate = "cmt in comment |filter: q| itemsPerPage: pageSize" current-page="currentPage">
                        ...
                        <td>@{{cmt.level}}</td>
                        <td>@{{cmt.note}}</td>                  
                        <td><button class="btn btn-info" ng-click="showModal(cmt.id_phan_hoi)"><i class="fas fa-edit"></i></button></td>
                        <td><button class="btn btn-danger" ng-click="deleteClick(cmt.id_phan_hoi)"><i class="fas fa-trash-alt"></i></button></td>
                    </tr> 
                </tbody>
            </table>
