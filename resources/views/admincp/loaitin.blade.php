            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <tr dir-paginate = "cate in loaitin |filter: q| itemsPerPage: pageSize" current-page="currentPage">
                        ...
                        <td>@{{ cate.id }}</td>
                        <td>@{{ cate.tenloai }}</td>
                        <td>@{{ cate.id_loai_tin }}</td>
                        <td>@{{ cate.Delet }}</td>

                        <td><button class="btn btn-info" ng-click="showModal(cate.id)"><i class="fas fa-edit"></i></button></td>
                        <td><button class="btn btn-danger" ng-click="deleteClick(cate.id)"><i class="fas fa-trash-alt"></i></button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="name" ng-model="cate.id">
                            </div>
                            </div>
                            <div class="form-group row">
                            <label for="name" class="col-sm-3 col-form-label">Tên loại</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="name" ng-model="cate.tenloai">
                            </div>
                            </div>
                            <div class="form-group row">
                            <label for="description" class="col-sm-3 col-form-label">ID loai tin</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" ng-model="cate.id_loai_tin">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="description" class="col-sm-3 col-form-label">Delet</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" ng-model="cate.Delet">
                            </div>
                          </div>
                    </div>
                </div>
